    ...
    <AuthShell mode="login">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 font-[family-name:var(--font-geist-sans)] text-sm leading-relaxed text-warm-granite">
          Autentikasi via Gmail Google. Akun Anda tidak pernah membutuhkan kata sandi
          tambahan — token aman dikelola oleh sistem.
        </p>
      </div>
      ...
      <MonoLabel className="mt-4 text-center" color="warm-granite">
